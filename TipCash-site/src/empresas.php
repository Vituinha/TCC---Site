...
<body class="container col-12 m-0 p-0">
        ...
        <section class="siteSection form-imp">
            <form id="cadastro"> 
                ...
                <input type="password" class="form-control" id="SenhaA">
                <label class="errorMessage" id="errorMessage-password">Preencha os campos com senhas iguais.</label>
                </div>
                <div class="form-group">
                <label for="exampleInputPassword1">Confirmar Senha</label>
                <input type="password" class="form-control" name="senhaC" id="SenhaB">
                </div>
                ...
                <button onclick="gravar()" class="btn btn-primary">Cadastrar</button>
            </form>
        </section>
